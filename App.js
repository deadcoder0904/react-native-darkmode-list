...
import { StyleSheet, View, SafeAreaView, StatusBar, ScrollView, Linking } from "react-native";
    ...
    return (
      <View style={styles.container}>
			<ScrollView>
				<StatusBar hidden />
        <SafeAreaView>
					<Text h2 style={styles.heading}>Dark Mode List</Text>
          <View style={styles.formWrapper}>
						...
						<Button title="Submit" onPress={this._onSubmit} buttonStyle={styles.btn} />
							...
							<View>
								{
									list.map((l, i) => (
										<ListItem
											...
											containerStyle={{backgroundColor: (i+1) % 2 ? "#2c3979": "#3c485e"}}
